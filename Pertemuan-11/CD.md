  ...
  build-and-deploy:
    ...
    - name: Build and push Docker image
      ...
      with:
        context: .
        push: true
        tags: ${{ secrets.DOCKERHUB_USERNAME }}/compro_2388010046:latest
    ...
    - name: SSH and deploy
      ...
      with:
        ...
        script: |
          ...
          docker pull ${{ secrets.DOCKERHUB_USERNAME }}/compro_2388010046:latest
          docker run -d --name compro_2388010046 -p 80:80 ${{ secrets.DOCKERHUB_USERNAME }}/compro_2388010046:latest
